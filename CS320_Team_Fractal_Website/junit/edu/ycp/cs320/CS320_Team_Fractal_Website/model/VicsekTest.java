...
public class VicsekTest {
	...
	public void testGetDefaultLocation(){
		...
		assertTrue(l.getX2() == Vicsek.SIZE);
		assertTrue(l.getY2() == Vicsek.SIZE);
	}
	...
	public void testSetDefaultParameters(){
		...
		assertEquals(p2.getX(), Vicsek.SIZE, DELTA);
		assertEquals(p2.getY(), 0, DELTA);

		assertEquals(p3.getX(), Vicsek.SIZE, DELTA);
		assertEquals(p3.getY(), Vicsek.SIZE, DELTA);
		
		assertEquals(p4.getX(), 0, DELTA);
		assertEquals(p4.getY(), Vicsek.SIZE, DELTA);
	...
	public void testCreateAppropriateController(){
		...
		assertTrue(control instanceof VicsekController);
	}
