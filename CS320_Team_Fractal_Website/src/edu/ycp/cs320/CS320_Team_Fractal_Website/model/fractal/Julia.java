...
public class Julia extends Fractal{
	...
	public String getInfo() {
		return	"The Julia set is generated by taking a compelx number, multipling it by itself " +
				"and then adds a constant. If this process can continue with the number staying stable " + 
